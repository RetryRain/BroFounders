  ...
  return (
    ...
    >
      <div className="max-w-300 mx-auto px-6 py-14 sm:py-20 flex flex-col gap-12 sm:gap-16">
        ...
        {/* Bottom */}
        <div className="italic border-t border-white/10 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-foreground/60 text-center">
